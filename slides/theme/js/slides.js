function main() {
    ...
    var nextSlide = function() {  
        ...
        if (slide != undefined) {
            var incrementals = slide.getElementsByClassName("incremental");
            console.log("slide#" + currentSlideNo + ": " + incrementals.length + " incrementals");
            console.log(slide);
            for (var i=0; i < incrementals.length; i++) {
                var e = incrementals[i];
                
                console.log(["incremental#" + i, e, e.style.display, e.style.display != "block"]);
    ...
    var prevSlide = function() {
        ...
        if (slide != undefined) {
            ...
            console.log(slide);
            for (var i=0; i < incrementals.length; i++) {
                var e = incrementals[incrementals.length-i-1];
    ...
    var showPrompt = function() {
        var asides = document.getElementsByClassName('o');
        var hidden = asides[0].style.display != 'inline';
        for (var i = 0; i < asides.length; i++) {
            asides.item(i).style.display = hidden ? 'inline' : 'none';
        }
    }
